...
KOBJS := assert.o main.o math.o memcheck.o raise.o ctype.o hexdump.o device.o glob.o swi_handc.o swi_handa.o swi_inst.o irq_inst.o timer_init.o setup.o timer_inita.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
